...
Welcome! This website contains documentation derived from countless hours of reverse engineering and research into the PlayStation 1 game **KulaQuest**.
...
If something relates specifically to the Japanese release of the game, it will be **explicity** stated.
...
- Technical documentation for most of KulaQuest's custom binary [formats](/formats/).
